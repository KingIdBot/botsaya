...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+62 822-4658-6611@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            break
                ...
                case 'bug':
                    ...
                    client.sendMessage('+62 822-4658-6611@s.whatsapp.net', options, text, {quoted: mek})
            ...
            case 'owner':
            case 'creator':
                  client.sendMessage(from,+62 822-4658-6611, MessageType.contact, { quoted: mek})
       client.sendMessage(from, 'Tuh nomer owner ku >_<, jangan spam atau ku block kamu',MessageType.text, { quoted: mek} )
           ...
           case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝘆??𝗵𝗵 @${mentioned[0].split('@')[0]} 𝗷𝗮𝗯𝗮𝘁𝗮𝗻 𝗮𝗱𝗺𝗶𝗻 𝗸𝗮𝗺𝘂 𝘀𝘂𝗱𝗮𝗵 𝗱𝗶 𝗰𝗼𝗽𝗼𝘁🏃`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
				case 'promote':
